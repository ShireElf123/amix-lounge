  ...
  <div className="pt-32 md:pt-52 pb-20 md:pb-36 min-h-screen px-6 md:px-16" style={{ background: G.dark }}>
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-28">
        {[IMG.kota, IMG.burger1, IMG.wingsTray, IMG.platter].map((src, i) => (
          <Reveal key={i} delay={i * 0.08}>
            <div className="aspect-square overflow-hidden border group" style={{ borderColor: G.border, background: "#1C0A0A", isolation: "isolate" }}>
